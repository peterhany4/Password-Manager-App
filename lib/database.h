...
public:
    ...
    void insertApp(sqlite3 *database, authentication user, string app_name, string app_username, string app_password);
    void updateApp(sqlite3 *database, string app_name, string app_username, string app_password);
